var formatter = (function(){
    ...
    var source_file = 'source-file.json';

    var google_prefix = 'https://maps.googleapis.com/maps/api/geocode/json?address=';
    var google_suffix = '&key=YOURgoogleAPIcodeGOEShereAFTERtheEQUALsign';

    var output = []; // will store our final output

    // a one-off query to google's geocode api, for reference
